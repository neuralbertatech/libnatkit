...
set(MOSQUITTO_SOURCE_DIR ${THIRD_PARTY_DIR}/mosquitto)
set(MOSQUITTO_BINARY_DIR ${BUILD_ROOT}/mosquitto)
add_subdirectory(${MOSQUITTO_SOURCE_DIR} ${MOSQUITTO_BINARY_DIR})

target_include_directories(libmosquitto INTERFACE ${MOSQUITTO_SOURCE_DIR}/include)
